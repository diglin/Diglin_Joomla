...
class Jfusion_Joomla_Helper_Cookies extends Mage_Core_Helper_Abstract {
	 ...
	 * @return integer
	 */
	static public function getHeader($ch, $string) {
	 ...
	 */
	private static function addCookie($name, $value = '', $expires = 0, $cookiepath = '', $cookiedomain = '', $secure = 0, $httponly = 0) {
	 ...
	 * @return array
	 */
	public static function parsecookies($cookielines) {
		$line = array ();
		$cookies = array ();
	 ...
	 * @param integer $httponly
	 */
	public static function setCookies($mycookies_to_set, $cookiedomain = null, $cookiepath = null, $expires = 0, $secure = 0, $httponly = 1) {
		$cookies = array ();
	 ...
	 */
	public static function getCookies($type = 'string'){
